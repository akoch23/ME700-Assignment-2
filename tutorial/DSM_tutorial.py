...
import numpy as np
from DSM_functions import local_elastic_stiffness_matrix, transformation_matrix, rotation_matrix
...
def structure(nodes, connection, load, supports):
    ...
    # Check for Matrix Singularity (undesirable)
...
# Define Inputs and Material Properties
E, nu = 1000, 0.3
b, h = 0.5, 1.0
A = b * h
I_y = h * b ** 3 / 12
...
print("Computed Displacements Values are: ", displacement)
print("Reaction Forces Values are: ", forces)
